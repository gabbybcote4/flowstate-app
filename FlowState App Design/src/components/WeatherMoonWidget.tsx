//src/components/WeatherMoonWidget.tsx
...
export function WeatherMoonWidget() {
  ...
  const getRandomWeatherCondition = (): WeatherData['condition'] => {
    ...
    // more likely to be sunny during day, cloudy at night
    if (hour >= 6 && hour < 18) {
  ...
  return (
    <div className="flow-card">
        ...
        {/* settings button */}
          <Dialog open={settingsOpen} onOpenChange={setSettingsOpen}>
            <DialogTrigger asChild>
              <button
                onClick={() => setSettingsOpen(true)} // ✅ force open state
          ...
          <DialogContent className="sm:max-w-[425px] z-[10000] relative">
            <DialogHeader>
      ...
      {settings.showIntention && (
        <div 
          className="rounded-xl text-xs text-center transition-all"
          style={{ 
